...
class model_classification_best_parameters():
    ...
    def batch_gd(self,model, criterion, optimizer):
        ...
        for it in (range(self.epochs)):            
            ...
            if test_loss < best_test_loss:
                torch.save(model, "./model/best_val_model_pytorch_best_"+self.model_type+'_'+self.feature_name+"_"+str(self.future_time)+"min_cl.pt")
