...
class LSTM_model(nn.Module):
    def __init__(self,num_layers, input_size, hidden_size,num_classes,device):
        super().__init__()
...
class LSTM_stacked_model(nn.Module):
    def __init__(self,num_layers_s, input_size_s, hidden_size_s_1,hidden_size_s_2,hidden_size_s_3,num_classes,device):
        super().__init__()
        self.num_classes = num_classes
        ...
        self.fc = nn.Linear(hidden_size_s_3,self.num_classes)
        self.device = device
...
class MLP_model(nn.Module):
    def __init__(self,inputsize,layer1,layer2,layer3,num_classes,device):
        super().__init__()
        self.num_classes = num_classes
...
class LSTM_MLP_model(nn.Module):
    def __init__(self,num_layers, input_size, hidden_size, fc_size,num_classes,device):
        super().__init__()
        self.num_classes = num_classes
        self.input_size = input_size
        self.hidden_size = hidden_size
...
class CNN_LSTM_model(nn.Module):
    def __init__(self,conv_filter_num,inception_num,leaky_relu_alpha,LSTM_num,num_classes,device):
        super().__init__()
        self.num_classes = num_classes
        ...
        self.fc1 = nn.Linear(LSTM_num, num_classes)
